...
proxylisttext = "proxy.txt" #nama list proxy
...
referer = ['http://google.com','http://bing.com','http://facebook.com','http://twitter.com', 'https://search.yahoo.com', 'https://duckduckgo.com/']
